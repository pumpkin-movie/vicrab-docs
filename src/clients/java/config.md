...
Depending on the limitations of the project (e.g. a mobile application with a limited connection, Vicrab hosted on an external network), it can be useful to compress the data beforehand or not.
